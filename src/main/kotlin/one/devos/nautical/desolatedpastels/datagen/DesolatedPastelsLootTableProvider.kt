...
class DesolatedPastelsLootTableProvider(
    ...
    override fun generate() {
        ...
        dropSelf(DesolatedPastelsBlocks.WHITE_PLANKS_FENCE)
        dropSelf(DesolatedPastelsBlocks.LIGHT_RED_PLANKS_FENCE)
        dropSelf(DesolatedPastelsBlocks.RED_PLANKS_FENCE)
        dropSelf(DesolatedPastelsBlocks.ORANGE_PLANKS_FENCE)
        dropSelf(DesolatedPastelsBlocks.YELLOW_PLANKS_FENCE)
        dropSelf(DesolatedPastelsBlocks.LIGHT_GREEN_PLANKS_FENCE)
        dropSelf(DesolatedPastelsBlocks.GREEN_PLANKS_FENCE)
        dropSelf(DesolatedPastelsBlocks.LIGHT_BLUE_PLANKS_FENCE)
        dropSelf(DesolatedPastelsBlocks.BLUE_PLANKS_FENCE)
        dropSelf(DesolatedPastelsBlocks.PURPLE_PLANKS_FENCE)
        dropSelf(DesolatedPastelsBlocks.MAGENTA_PLANKS_FENCE)
        dropSelf(DesolatedPastelsBlocks.BROWN_PLANKS_FENCE)
        dropSelf(DesolatedPastelsBlocks.LIGHT_GRAY_PLANKS_FENCE)
        dropSelf(DesolatedPastelsBlocks.GRAY_PLANKS_FENCE)
        dropSelf(DesolatedPastelsBlocks.BLACK_PLANKS_FENCE)

        dropSelf(DesolatedPastelsBlocks.WHITE_PLANKS_FENCE_GATE)
        dropSelf(DesolatedPastelsBlocks.LIGHT_RED_PLANKS_FENCE_GATE)
        dropSelf(DesolatedPastelsBlocks.RED_PLANKS_FENCE_GATE)
        dropSelf(DesolatedPastelsBlocks.ORANGE_PLANKS_FENCE_GATE)
        dropSelf(DesolatedPastelsBlocks.YELLOW_PLANKS_FENCE_GATE)
        dropSelf(DesolatedPastelsBlocks.LIGHT_GREEN_PLANKS_FENCE_GATE)
        dropSelf(DesolatedPastelsBlocks.GREEN_PLANKS_FENCE_GATE)
        dropSelf(DesolatedPastelsBlocks.LIGHT_BLUE_PLANKS_FENCE_GATE)
        dropSelf(DesolatedPastelsBlocks.BLUE_PLANKS_FENCE_GATE)
        dropSelf(DesolatedPastelsBlocks.PURPLE_PLANKS_FENCE_GATE)
        dropSelf(DesolatedPastelsBlocks.MAGENTA_PLANKS_FENCE_GATE)
        dropSelf(DesolatedPastelsBlocks.BROWN_PLANKS_FENCE_GATE)
        dropSelf(DesolatedPastelsBlocks.LIGHT_GRAY_PLANKS_FENCE_GATE)
        dropSelf(DesolatedPastelsBlocks.GRAY_PLANKS_FENCE_GATE)
        dropSelf(DesolatedPastelsBlocks.BLACK_PLANKS_FENCE_GATE)
