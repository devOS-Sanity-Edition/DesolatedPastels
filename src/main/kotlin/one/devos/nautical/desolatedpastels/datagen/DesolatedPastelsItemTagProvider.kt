...
class DesolatedPastelsItemTagProvider(
    ...
    override fun addTags(arg: HolderLookup.Provider) {
        ...
        getOrCreateTagBuilder(InnerPastelsItemTags.FENCES)
            .add(DesolatedPastelsBlocks.WHITE_PLANKS_FENCE.asItem())
            .add(DesolatedPastelsBlocks.LIGHT_RED_PLANKS_FENCE.asItem())
            .add(DesolatedPastelsBlocks.RED_PLANKS_FENCE.asItem())
            .add(DesolatedPastelsBlocks.ORANGE_PLANKS_FENCE.asItem())
            .add(DesolatedPastelsBlocks.YELLOW_PLANKS_FENCE.asItem())
            .add(DesolatedPastelsBlocks.LIGHT_GREEN_PLANKS_FENCE.asItem())
            .add(DesolatedPastelsBlocks.GREEN_PLANKS_FENCE.asItem())
            .add(DesolatedPastelsBlocks.LIGHT_BLUE_PLANKS_FENCE.asItem())
            .add(DesolatedPastelsBlocks.BLUE_PLANKS_FENCE.asItem())
            .add(DesolatedPastelsBlocks.PURPLE_PLANKS_FENCE.asItem())
            .add(DesolatedPastelsBlocks.MAGENTA_PLANKS_FENCE.asItem())
            .add(DesolatedPastelsBlocks.BROWN_PLANKS_FENCE.asItem())
            .add(DesolatedPastelsBlocks.LIGHT_GRAY_PLANKS_FENCE.asItem())
            .add(DesolatedPastelsBlocks.GRAY_PLANKS_FENCE.asItem())
            .add(DesolatedPastelsBlocks.BLACK_PLANKS_FENCE.asItem())

        getOrCreateTagBuilder(InnerPastelsItemTags.FENCE_GATES)
            .add(DesolatedPastelsBlocks.WHITE_PLANKS_FENCE_GATE.asItem())
            .add(DesolatedPastelsBlocks.LIGHT_RED_PLANKS_FENCE_GATE.asItem())
            .add(DesolatedPastelsBlocks.RED_PLANKS_FENCE_GATE.asItem())
            .add(DesolatedPastelsBlocks.ORANGE_PLANKS_FENCE_GATE.asItem())
            .add(DesolatedPastelsBlocks.YELLOW_PLANKS_FENCE_GATE.asItem())
            .add(DesolatedPastelsBlocks.LIGHT_GREEN_PLANKS_FENCE_GATE.asItem())
            .add(DesolatedPastelsBlocks.GREEN_PLANKS_FENCE_GATE.asItem())
            .add(DesolatedPastelsBlocks.LIGHT_BLUE_PLANKS_FENCE_GATE.asItem())
            .add(DesolatedPastelsBlocks.BLUE_PLANKS_FENCE_GATE.asItem())
            .add(DesolatedPastelsBlocks.PURPLE_PLANKS_FENCE_GATE.asItem())
            .add(DesolatedPastelsBlocks.MAGENTA_PLANKS_FENCE_GATE.asItem())
            .add(DesolatedPastelsBlocks.BROWN_PLANKS_FENCE_GATE.asItem())
            .add(DesolatedPastelsBlocks.LIGHT_GRAY_PLANKS_FENCE_GATE.asItem())
            .add(DesolatedPastelsBlocks.GRAY_PLANKS_FENCE_GATE.asItem())
            .add(DesolatedPastelsBlocks.BLACK_PLANKS_FENCE_GATE.asItem())
