...
class DesolatedPastelsEnglishLanguageProvider(dataGenerator: FabricDataOutput, registriesFuture: CompletableFuture<HolderLookup.Provider>) : FabricLanguageProvider(dataGenerator, "en_us", registriesFuture) {
    override fun generateTranslations(registryLookup: HolderLookup.Provider, translationBuilder: TranslationBuilder) {
        ...
        translationBuilder.add(DesolatedPastelsBlocks.WHITE_PLANKS_FENCE, "White Planks Fence")
        translationBuilder.add(DesolatedPastelsBlocks.LIGHT_RED_PLANKS_FENCE, "Light Red Planks Fence")
        translationBuilder.add(DesolatedPastelsBlocks.RED_PLANKS_FENCE, "Red Planks Fence")
        translationBuilder.add(DesolatedPastelsBlocks.ORANGE_PLANKS_FENCE, "Orange Planks Fence")
        translationBuilder.add(DesolatedPastelsBlocks.YELLOW_PLANKS_FENCE, "Yellow Planks Fence")
        translationBuilder.add(DesolatedPastelsBlocks.LIGHT_GREEN_PLANKS_FENCE, "Light Green Planks Fence")
        translationBuilder.add(DesolatedPastelsBlocks.GREEN_PLANKS_FENCE, "Green Planks Fence")
        translationBuilder.add(DesolatedPastelsBlocks.LIGHT_BLUE_PLANKS_FENCE, "Light Blue Planks Fence")
        translationBuilder.add(DesolatedPastelsBlocks.BLUE_PLANKS_FENCE, "Blue Planks Fence")
        translationBuilder.add(DesolatedPastelsBlocks.PURPLE_PLANKS_FENCE, "Purple Planks Fence")
        translationBuilder.add(DesolatedPastelsBlocks.MAGENTA_PLANKS_FENCE, "Magenta Planks Fence")
        translationBuilder.add(DesolatedPastelsBlocks.BROWN_PLANKS_FENCE, "Brown Planks Fence")
        translationBuilder.add(DesolatedPastelsBlocks.LIGHT_GRAY_PLANKS_FENCE, "Light Gray Planks Fence")
        translationBuilder.add(DesolatedPastelsBlocks.GRAY_PLANKS_FENCE, "Gray Planks Fence")
        translationBuilder.add(DesolatedPastelsBlocks.BLACK_PLANKS_FENCE, "Black Planks Fence")

        translationBuilder.add(DesolatedPastelsBlocks.WHITE_PLANKS_FENCE_GATE, "White Planks Fence Gate")
        translationBuilder.add(DesolatedPastelsBlocks.LIGHT_RED_PLANKS_FENCE_GATE, "Light Red Planks Fence Gate")
        translationBuilder.add(DesolatedPastelsBlocks.RED_PLANKS_FENCE_GATE, "Red Planks Fence Gate")
        translationBuilder.add(DesolatedPastelsBlocks.ORANGE_PLANKS_FENCE_GATE, "Orange Planks Fence Gate")
        translationBuilder.add(DesolatedPastelsBlocks.YELLOW_PLANKS_FENCE_GATE, "Yellow Planks Fence Gate")
        translationBuilder.add(DesolatedPastelsBlocks.LIGHT_GREEN_PLANKS_FENCE_GATE, "Light Green Planks Fence Gate")
        translationBuilder.add(DesolatedPastelsBlocks.GREEN_PLANKS_FENCE_GATE, "Green Planks Fence Gate")
        translationBuilder.add(DesolatedPastelsBlocks.LIGHT_BLUE_PLANKS_FENCE_GATE, "Light Blue Planks Fence Gate")
        translationBuilder.add(DesolatedPastelsBlocks.BLUE_PLANKS_FENCE_GATE, "Blue Planks Fence Gate")
        translationBuilder.add(DesolatedPastelsBlocks.PURPLE_PLANKS_FENCE_GATE, "Purple Planks Fence Gate")
        translationBuilder.add(DesolatedPastelsBlocks.MAGENTA_PLANKS_FENCE_GATE, "Magenta Planks Fence Gate")
        translationBuilder.add(DesolatedPastelsBlocks.BROWN_PLANKS_FENCE_GATE, "Brown Planks Fence Gate")
        translationBuilder.add(DesolatedPastelsBlocks.LIGHT_GRAY_PLANKS_FENCE_GATE, "Light Gray Planks Fence Gate")
        translationBuilder.add(DesolatedPastelsBlocks.GRAY_PLANKS_FENCE_GATE, "Gray Planks Fence Gate")
        translationBuilder.add(DesolatedPastelsBlocks.BLACK_PLANKS_FENCE_GATE, "Black Planks Fence Gate")
